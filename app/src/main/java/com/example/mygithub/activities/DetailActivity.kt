...
import com.example.mygithub.adapter.SectionsPagerAdapter
import com.example.mygithub.data.UserData
import com.example.mygithub.databinding.ActivityDetailBinding
import com.example.mygithub.db.DatabaseContract.FavoriteColumns.Companion.AVATAR
import com.example.mygithub.db.DatabaseContract.FavoriteColumns.Companion.COMPANY
import com.example.mygithub.db.DatabaseContract.FavoriteColumns.Companion.CONTENT_URI
import com.example.mygithub.db.DatabaseContract.FavoriteColumns.Companion.LOCATION
import com.example.mygithub.db.DatabaseContract.FavoriteColumns.Companion.NAME
import com.example.mygithub.db.DatabaseContract.FavoriteColumns.Companion.USERNAME
        ...
        when (view.id) {
            R.id.fab_favorite -> {
                if (!statusFavorite) {
                    ...
                    val id = favData.username.toString()
