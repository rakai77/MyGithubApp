...
import com.example.mygithub.adapter.FollowersAdapter
...
class FollowersFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        followersAdapter = FollowersAdapter(listUserFragment)
        listUserFragment.clear()
        val dataFollowers = activity!!.intent.getParcelableExtra<UserData>(EXTRA_DATA) as UserData
        getFollowers(dataFollowers.username.toString())
    }
